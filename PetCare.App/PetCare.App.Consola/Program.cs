...
namespace PetCare.App.Consola
{
    class program
    {
        ...
        private static void AddMascotaConVisita()
        {
            var mascota = new Mascota
            {
                raza = "Pincher",
                ...
                Ciudad = "Bucaramanga",
                //Nacimiento="01-12-2022"
                visitasMedicas = new List<Visita>
                {
                    new Visita
                    {
                        FechaVisita=new DateTime(2022,01,01,12,45,35),
                        Recomendaciones="cuidado no comer carne",
                        Diagnostico="buenas salud"
                    }
                }
